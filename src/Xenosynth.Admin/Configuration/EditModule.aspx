<%@ Page language="c#" MasterPageFile="~/Default.Master" Codebehind="EditModule.aspx.cs" AutoEventWireup="True" Inherits="Xenosynth.Admin.Configuration.EditModule" %>
...
<asp:Content ContentPlaceHolderID="Main" runat="server" >
	...
	<fieldset>
		...
		<asp:RequiredFieldValidator CssClass="error" Runat="server" ControlToValidate="TextBoxName" Display="Dynamic" ErrorMessage="Required." ID="Requiredfieldvalidator1"/>
		...
		<asp:RequiredFieldValidator CssClass="error" Runat="server" ControlToValidate="TextBoxResourceFolder" Display="Dynamic" ErrorMessage="Required." ID="Requiredfieldvalidator2"/>
		...
		<asp:CheckBox CssClass="checkbox" Runat="server" ID="CheckBoxIsEnabled" Text="Is enabled?" />
		<span class="toolTip">Whether the module should be initialized.</span>
		
		
		<asp:Button Runat="server" CssClass="submit" Text="Update &raquo;" OnClick="ButtonUpdateModule_OnClick" ID="Button1"/>
	...
	<DataBinding:DataBindingManager ID="DataBindingManagerModule" runat="server">
		...
		<DataBinding:CheckBoxBinding ControlToBind="CheckBoxIsEnabled" DataMember="IsEnabled" />
