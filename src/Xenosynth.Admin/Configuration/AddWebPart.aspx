<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="AddWebPart.aspx.cs" Inherits="Xenosynth.Admin.Configuration.AddWebPart" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
	...
	<fieldset>
		...
		<asp:Button Runat="server" CssClass="submit" Text="Add &raquo;" OnClick="ButtonAdd_OnClick" ID="Button1"/>
