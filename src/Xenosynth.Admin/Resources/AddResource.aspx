<%@ Page language="c#" Codebehind="AddResource.aspx.cs" AutoEventWireup="True" Inherits="Xenosynth.Admin.Resources.AddResource" %>
...
<html>
  <head>
    <title>Xenosynth - Add Resource</title>
		...
		<Fluent:Template runat="server" id=TemplateLayout1 PageLayoutFile="~/StandardTemplate.ascx" >
			...
			<Fluent:TemplateSection id="Main" runat="server">
				...
				<fieldset>
					...
					<asp:Button Runat="server" CssClass="submit" Text="Add &raquo;" OnClick="ButtonAddResource_OnClick" ID="Button1"/>
