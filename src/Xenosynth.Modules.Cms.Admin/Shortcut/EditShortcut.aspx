<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="EditShortcut.aspx.cs" Inherits="Xenosynth.Modules.Cms.Admin.Shortcut.EditShortcut" Title="Untitled Page" %>
...
<xs:MessageBox runat="server" ID="MessageBox1" CssClass="message" />
	<xs:ShortcutTabControl ID="ShortcutTabControl1" runat="server" FileID="<%# CurrentShortcut.ID %>"  Selected="Properties" />
    <div class="formPanel">
	<fieldset>
