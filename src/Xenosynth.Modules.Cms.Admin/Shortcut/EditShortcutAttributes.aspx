<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="EditShortcutAttributes.aspx.cs" Inherits="Xenosynth.Modules.Cms.Admin.Shortcut.EditShortcutAttributes" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Main" runat="server">
    ...
    <xs:SlidePanel runat="Server">
	    ...
	    <MainPanelTemplate>
            ...
            <xs:ShortcutTabControl ID="ShortcutTabControl1" runat="server" FileID="<%# CurrentShortcut.ID %>"  Selected="Attributes" />
            <div class="formPanel">
            <fieldset>
