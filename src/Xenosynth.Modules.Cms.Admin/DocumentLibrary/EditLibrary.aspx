<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="EditLibrary.aspx.cs" Inherits="Xenosynth.Modules.Cms.Admin.DocumentLibrary.EditLibrary" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
    ...
    <xs:DocumentLibraryTabControl ID="DocumentLibraryTabControl1" runat="server" DirectoryID="<%# CurrentDirectory.ID %>"  Selected="Properties" />
    <div class="formPanel">
        <fieldset>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Side" runat="server">
    <xs:DocumentLibraryTasks ID="DocumentLibraryTasks1" runat="server" CurrentLibrary="<%# CurrentDirectory %>" />
