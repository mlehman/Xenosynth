<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="ViewDocumentRevisions.aspx.cs" Inherits="Xenosynth.Modules.Cms.Admin.DocumentLibrary.ViewDocumentRevisions" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
	...
	<xs:DocumentTabControl ID="DocumentTabControl1" runat="server" FileID="<%# CurrentFile.ID %>" Selected="Revisions" />
	<div class="formPanel">
