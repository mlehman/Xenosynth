<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="BrowseTemplateGallery.aspx.cs" Inherits="Xenosynth.Admin.Content.TemplateGallery.BrowseTemplateGallery" Title="Untitled Page" %>
	...
	<xs:SlidePanel runat="Server">
	    ...
	    <MainPanelTemplate>
	            ...
	            <asp:DataGrid ID="DataGridFiles" 
		            ...
		            <Columns>
			            <asp:TemplateColumn HeaderStyle-Wrap="false">
				            ...
				            <ItemTemplate>
					            ...
					            <asp:HyperLink ID="HyperLink1" Runat="server" 
					                ...
					                NavigateUrl='<%# (bool)DataBinder.Eval(Container.DataItem, "FileType.IsDirectory") ? DataBinder.Eval(Container.DataItem, "FileType.BrowseUrl") + DataBinder.Eval(Container.DataItem, "ID", "?FileID={0}") : DataBinder.Eval(Container.DataItem, "FileType.EditUrl") + DataBinder.Eval(Container.DataItem, "ID", "?FileID={0}")%>' 
			            ...
			            <asp:TemplateColumn HeaderStyle-Width="60">
			                <HeaderTemplate><asp:LinkButton ID="LinkButton4"  Runat="Server" CommandName="Sort" CommandArgument="Version">Version
			            ...
			            <asp:TemplateColumn SortExpression="SortOrder" HeaderStyle-Wrap="false" HeaderStyle-Width="75">
			            ...
			            <asp:TemplateColumn HeaderText="Tasks" HeaderStyle-CssClass="tasksColumn" ItemStyle-CssClass="tasksColumn" HeaderStyle-Width="50">
				            <ItemTemplate>
				            <nobr>
	            ...
	            <erp:EmptyRepeaterPanel runat="server" control="DataGridFiles" ID="Emptyrepeaterpanel2" NAME="Emptyrepeaterpanel1">
		            <span class="warning">This template gallery does not contain any files.</span>
