<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="EditTemplateGalleryAttributes.aspx.cs" Inherits="Xenosynth.Modules.Cms.Admin.TemplateGallery.EditTemplateGalleryAttributes" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
	...
	<xs:TemplateGalleryTabControl ID="TemplateGalleryTabControl1" runat="server" DirectoryID="<%# CurrentFile.ID %>" Selected="Attributes" />
	<div class="formPanel">
...
<asp:Content ID="Content2" ContentPlaceHolderID="Side" runat="server">
     <xs:TemplateGalleryTasks ID="TemplateGalleryTasks1" runat="server" CurrentGallery="<%# CurrentFile %>" />
</asp:Content>
