<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="EditTemplateAttributes.aspx.cs" Inherits="Xenosynth.Modules.Cms.Admin.TemplateGallery.EditTemplateAttributes" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
	...
	<xs:TemplateTabControl ID="TemplateTabControl1" runat="server" FileID="<%# CurrentFile.ID %>" Selected="Attributes" />
	<div class="formPanel">
...
<asp:Content ID="Content2" ContentPlaceHolderID="Side" runat="server">
    <xs:TemplateTasks ID="TemplateTasks1" runat="server" CurrentTemplate="<%# CurrentFile %>" />
    <xs:TemplateGalleryTasks ID="TemplateGalleryTasks1" runat="server" CurrentGallery="<%# CurrentFile.ParentDirectory %>" />
</asp:Content>
