<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="EditImageAttributes.aspx.cs" Inherits="Xenosynth.Admin.Content.ImageGallery.EditImageAttributes" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
	...
	<xs:ImageTabControl ID="ImageTabControl1" runat="server" FileID="<%# CurrentFile.ID %>" Selected="Attributes" />
	<div class="formPanel">
