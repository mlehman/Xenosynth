<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="EditGalleryAttributes.aspx.cs" Inherits="Xenosynth.Admin.Content.ImageGallery.EditGalleryAttributes" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
	...
	<xs:ImageGalleryTabControl ID="ImageGalleryTabControl1" runat="server" FileID="<%# CurrentFile.ID %>" Selected="Attributes" />
	<div class="formPanel">
