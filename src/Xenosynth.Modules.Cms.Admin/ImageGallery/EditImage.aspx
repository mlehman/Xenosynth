<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="EditImage.aspx.cs" Inherits="Xenosynth.Admin.Content.ImageGallery.EditImage" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
	...
	<xs:ImageTabControl ID="ImageTabControl1" runat="server" FileID="<%# CurrentImage.ID %>" Selected="Properties" />
	<div class="formPanel">
	    <fieldset>
		    ...
		    <label for="TextBoxAltText">Alt Text:</label>  <asp:TextBox CssClass="input" Runat="server" style="width: 250px;" ID="TextBoxAltText"  MaxLength="50"/> <br />
		    <span class="toolTip">Alternate text for search engines.</span>
		    ...
		    <br />
		    <span class="toolTip">A description of the image for searching.<asp:TextBox Runat="server" ID="TextBoxDescriptionCount" CssClass="charCount" Columns="4" />&nbsp; characters remaining</span>
	...
	<databinding:DataBindingManager ID="DataBindingManagerImage" runat="server">
		...
		<DataBinding:TextBoxBinding ControlToBind="TextBoxAltText" DataMember="AltText" />
