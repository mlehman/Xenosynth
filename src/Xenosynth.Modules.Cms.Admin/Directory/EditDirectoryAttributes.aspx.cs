...
namespace Xenosynth.Admin.Content.Directory {
    public partial class EditDirectoryAttributes : System.Web.UI.Page {
        ...
        public CmsWebDirectory CurrentDirectory {
            get {
                if (directoryCache == null) {
                    directoryCache = CmsWebDirectory.FindByID(DirectoryID);
                } 
        ...
        protected void BindAttributes() {
            DataGridAttributes.DataSource = CmsFileAttribute.FindByFileID(CurrentDirectory.ID);
