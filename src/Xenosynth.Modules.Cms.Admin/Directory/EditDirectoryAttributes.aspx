<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="EditDirectoryAttributes.aspx.cs" Inherits="Xenosynth.Admin.Content.Directory.EditDirectoryAttributes" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="Main" runat="server">
    ...
    <xs:DirectoryTabControl ID="DirectoryTabControl1" runat="server" DirectoryID="<%# CurrentDirectory.ID %>"  Selected="Attributes" />
    <div class="formPanel">
...
<asp:Content ID="Content2" ContentPlaceHolderID="Side" runat="server">
    <xs:DirectoryTasks ID="DirectoryTasks1" runat="server" CurrentDirectory="<%# CurrentDirectory %>" />
