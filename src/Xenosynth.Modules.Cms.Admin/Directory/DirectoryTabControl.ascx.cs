...
namespace Xenosynth.Admin.Content {
    ...
    public partial class DirectoryTabControl : System.Web.UI.UserControl {
        ...
        private void Page_Load(object sender, System.EventArgs e) {
            if (!IsPostBack) {
                ...
                t.NavigateUrl = "EditDirectory.aspx?FileID=" + DirectoryID;
                TabControlDirectory.Tabs.Add(t);

                t = new Tab();
                t.Text = "Attributes";
                t.Enabled = DirectoryID != Guid.Empty;
                t.NavigateUrl = "EditDirectoryAttributes.aspx?FileID=" + DirectoryID;
                TabControlDirectory.Tabs.Add(t);
                ...
                t.Text = "History";
                t.Enabled = DirectoryID != Guid.Empty;
                t.NavigateUrl = "ViewDirectoryHistory.aspx?FileID=" + DirectoryID;
                TabControlDirectory.Tabs.Add(t);
