<%@ Page Language="C#" MasterPageFile="~/Default.Master" AutoEventWireup="true" CodeBehind="BrowseBlog.aspx.cs" Inherits="Xenosynth.Modules.Blog.Admin.BrowseBlog" %>
	    ...
	    <MainPanelTemplate>
	            ...
	            <asp:DataGrid ID="DataGridFiles" 
		            ...
		            <Columns>
			            ...
			            <asp:TemplateColumn  HeaderStyle-Width="100" Visible="False">
			            ...
			            <asp:TemplateColumn HeaderStyle-Width="60">
			                <HeaderTemplate><asp:LinkButton Runat="Server" CommandName="Sort" CommandArgument="Version">Author
						            <asp:Image runat="server" ImageUrl='<%# "~/images/icon_" + DataGridAdapterFiles.GetSortOrder("Author") + ".gif" %>' /></asp:LinkButton>
				            </HeaderTemplate>
				            <ItemTemplate><div class="td_text"><div class="td_text"><%# DataBinder.Eval(Container.DataItem, "Author") %></div></div></ItemTemplate>
			            </asp:TemplateColumn>
			            ...
			            <asp:TemplateColumn  HeaderStyle-Wrap="false"  HeaderStyle-Width="75">
			                <HeaderTemplate><asp:LinkButton   Runat="Server" CommandName="Sort" CommandArgument="PublishStartSortable">Published
						            <asp:Image runat="server" ImageUrl='<%# "~/images/icon_" + DataGridAdapterFiles.GetSortOrder("PublishStart") + ".gif" %>' /></asp:LinkButton>
				            </HeaderTemplate>
				            <ItemTemplate><div class="td_text"><div class="td_text"><%#  (bool)Eval("PublishStart.IsNull") ? "" : Eval("PublishStart.Value", "{0:d}") %></div></div></ItemTemplate>
			            </asp:TemplateColumn>
	            ...
	            <erp:EmptyRepeaterPanel runat="server" control="DataGridFiles" ID="Emptyrepeaterpanel2" NAME="Emptyrepeaterpanel1">
		            <span class="warning">This blog does not contain any posts.</span>
	            ...
	            <dga:DataGridAdapter 
                  ...
                  SortHistory="1" 
                  AutoDataBind="False"
                  BaseTypeName="Xenosynth.Modules.Blog.BlogPost,Xenosynth.Modules.Blog"
                  HideEmptyPager="True"
